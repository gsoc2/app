...
describe("[lib] github methods", () => {
  ...
  it("Should return a valid image src link", () => {
    const result = generateGhOgImage("https://github.com/gsoc2/hot/pull/448");
  ...
  it("Should return an object with valid org name, repo name and issue", () => {
    const result = generateRepoParts("https://github.com/gsoc2/insights/pull/1470");
  ...
  it("Should return an object with valid org name, repo name and issue", () => {
    const result = generateRepoParts("github.com/gsoc2/insights/pull/1470");
    expect(result.isValidUrl).toEqual(true);
    expect(result.apiPaths).toEqual({
      orgName: "open-sauced",
      repoName: "insights",
  ...
  it("Should return an object with a valid org name and repo name", () => {
    const result = generateRepoParts("https://github.com/gsoc2/insights");
    expect(result.isValidUrl).toEqual(true);
    expect(result.apiPaths).toEqual({
      orgName: "open-sauced",
      repoName: "insights",
  ...
  it("Should return an object with isValidUrl set to false", () => {
    const result = generateRepoParts("https://gsoc2.github.com/insights/hub/insights/new");
  ...
  it("Should return true", () => {
    const result = isValidIssueUrl("https://github.com/gsoc2/pizza-cli/issues/19");
